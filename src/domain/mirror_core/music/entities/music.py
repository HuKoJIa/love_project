...
from src.domain.mirror_core.music.events.music_created import MusicCreated
from src.domain.mirror_core.music.events.music_deleted import MusicDeleted
from src.domain.mirror_core.music.events.music_marked import MusicMarkedAsFavorite
from src.domain.mirror_core.music.events.music_unmarked import MusicUnmarkedAsFavorite
from src.domain.mirror_core.music.exceptions import MusicIsDeletedError
from src.domain.mirror_core.music.value_objects.music_artist import MusicArtist
from src.domain.mirror_core.music.value_objects.music_title import MusicTitle
from src.domain.mirror_core.music.value_objects.music_id import MusicId
from src.domain.mirror_core.music.value_objects.music_url import MusicUrl
